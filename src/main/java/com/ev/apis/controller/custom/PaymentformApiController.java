...
public class PaymentformApiController {
	...
	public R removePaymentform(
			@ApiParam(value = "根据id删除付款单",required = true) @RequestParam(value = "id",defaultValue = "",required = true) Long id) {
	...
	public R listApi( @ApiParam(value = "开始时间",required = false) @RequestParam(value = "startTime",defaultValue = "",required = false)  String startTime,
			...
			@ApiParam(value = "付款单号",required = false) @RequestParam(value = "payNum",required = false) String payNum,
			@ApiParam(value = "供应商",required = false) @RequestParam(value = "company",defaultValue = "",required = false) Long company,
			@ApiParam(value = "业务源单号",required = false) @RequestParam(value = "sourceNum",required = false) String sourceNum,
			@ApiParam(value = "付款人",required = false) @RequestParam(value = "drawee",required = false) String drawee,
			@ApiParam(value = "付款帐号",required = false) @RequestParam(value = "payAccount",required = false) String payAccount,
