...
//		String imgPath = "D:/java/sxy/pic/61.jpg";
//		File file = new File(imgPath);
//		boolean ifExists = UploadUtils.judeFileExists(file);
//		if(!ifExists){
//			String content = "/lessons/signIn?id=61";
//			CodeUtil.encodePR(content, 400, 400, imgPath);
//		}
